...
export const ROUTES: RouteInfo[] = [
  ...
  { path: '/icons', title: 'Products',  icon:'ni-basket text-info', class: '' },
  { path: '/user-profile', title: 'Orders',  icon:'ni-money-coins text-blue', class: '' },
  { path: '/customer', title: 'Customer',  icon:'ni-single-02 text-yellow', class: '' },
  // { path: '/login', title: 'Login',  icon:'ni-key-25 text-info', class: '' },
  { path: '/register', title: 'Coupon',  icon:'fa fa-ticket-alt text-info', class: '' },
